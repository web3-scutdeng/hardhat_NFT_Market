...
!developmentChains.includes(network.name)
    ...
    : describe("Nft Marketplace Unit Tests", () => {
          ...
          beforeEach(async () => {
              ...
              await basicNft.approve(nftMarketplaceContract.address, TOKEN_ID) //授权market此nft
          })
          ...
          describe("listItem", () => {
              ...
              it("exclusively items that haven't been listed", async function () {
                  await nftMarketplace.listItem(basicNft.address, TOKEN_ID, PRICE) //再一次list,already listed
              ...
              it("exclusively allows owners to list", async function () {
                  nftMarketplace = nftMarketplaceContract.connect(user) //连接user（user不是NFT拥有者，故会报错）
          ...
          describe("cancelListing", function () {
              it("reverts if there is no listing", async function () {
                  ...
                  await expect(
                      nftMarketplace.cancelListing(basicNft.address, TOKEN_ID) //在这之前还没有List,会报错
